...
/** 平台标志用实心字形（品牌 logo 没法用线描画），只在下载入口那几处出现 */
const glyph = (path: React.ReactNode, viewBox = '0 0 24 24') =>
  function Glyph({ size = 16, className }: Props) {
    return (
...
export const IconAndroid = glyph(
  <path d="M17.523 15.341a1 1 0 1 1 0-2 1 1 0 0 1 0 2m-11.046 0a1 1 0 1 1 0-2 1 1 0 0 1 0 2m11.405-6.02 1.997-3.46a.416.416 0 0 0-.72-.415l-2.022 3.503C15.59 8.244 13.853 7.85 12 7.85s-3.59.393-5.137 1.099L4.841 5.447a.416.416 0 0 0-.72.415l1.997 3.46C2.69 11.187.343 14.659 0 18.761h24c-.344-4.102-2.69-7.574-6.118-9.44" />
)
export const IconWindows = glyph(
  <path d="M3 5.6l7.4-1v6.9H3zM11.5 4.4L21 3v8.5h-9.5zM3 12.5h7.4v6.9L3 18.4zM11.5 12.5H21V21l-9.5-1.3z" />
)
export const IconApple = glyph(
